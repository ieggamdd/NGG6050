...
initialMuR = mean(reciprocalRT);           % Initial guess for muR (mean of reciprocal RT)
initialDeltaS = std(reciprocalRT);         % Initial guess for deltaS (std dev of reciprocal RT)
initialValues = [initialMuR, initialDeltaS];
...
% Overlay model predictions using fitted muR and deltaS
muR = fits(1);
deltaS = fits(2);
